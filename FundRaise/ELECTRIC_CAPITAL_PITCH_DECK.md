...
- **31 LLM models** — GPT-4o, Claude, Gemini, DeepSeek, Llama
- **Pay-per-use** — USDC on Base, no minimums
- **No accounts** — Wallet is identity
- **Transparent pricing** — Provider cost + 5%, published

Live on Base mainnet since January 2, 2026. Users onboarding now.
...
|-------------|-----------------|--------|
| Coinbase AgentKit | 10,000+ agent developers | Q1 2026 |
...
One merged PR to AgentKit reaches more builders than 100 Twitter threads.
...
| Metric | Status |
|--------|--------|
| AI Gateway | **Live** — Base mainnet, January 2, 2026 |
| Models available | 31 |
| Services indexed | 618+ |
...
- **Uses BlockRun AI Gateway** — Analyzes markets via GPT-4, Claude, DeepSeek
- **Places real trades** — Autonomous decisions, real money
- **Runs 24/7** — Deployed to Tokyo (non-geoblocked region)

This isn't a mock-up. It's a working agent using BlockRun's infrastructure to access AI models, analyze prediction markets, and execute trades—completely autonomously.
